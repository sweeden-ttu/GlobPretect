...
This document defines the **IEEE 752 64-bit geometrica Z field (zed)** specifications from the data-structures repository. All implementations across all languages and all repositories that consume or extend data-structures MUST follow these rules for numeric representation.
...
- Canonical spec: data-structures repository `docs/IEEE_752_64BIT_GEOMETRICA_Z_FIELD_ZED_SPECIFICATIONS.md`
